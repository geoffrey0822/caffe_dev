...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ExpDecayLossParameter expdecayloss_param = 150;
  inline bool has_expdecayloss_param() const;
  inline void clear_expdecayloss_param();
  static const int kExpdecaylossParamFieldNumber = 150;
  inline const ::caffe::ExpDecayLossParameter& expdecayloss_param() const;
  inline ::caffe::ExpDecayLossParameter* mutable_expdecayloss_param();
  inline ::caffe::ExpDecayLossParameter* release_expdecayloss_param();
  inline void set_allocated_expdecayloss_param(::caffe::ExpDecayLossParameter* expdecayloss_param);
 ...
 private:
  ...
  inline void set_has_expdecayloss_param();
  inline void clear_has_expdecayloss_param();
  ...
  ::caffe::ExpDecayLossParameter* expdecayloss_param_;
...
class ExpDecayLossParameter : public ::google::protobuf::Message {
 public:
  ExpDecayLossParameter();
  virtual ~ExpDecayLossParameter();

  ExpDecayLossParameter(const ExpDecayLossParameter& from);

  inline ExpDecayLossParameter& operator=(const ExpDecayLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ExpDecayLossParameter& default_instance();

  void Swap(ExpDecayLossParameter* other);

  // implements Message ----------------------------------------------

  ExpDecayLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ExpDecayLossParameter& from);
  void MergeFrom(const ExpDecayLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional float scaler = 1 [default = 1];
  inline bool has_scaler() const;
  inline void clear_scaler();
  static const int kScalerFieldNumber = 1;
  inline float scaler() const;
  inline void set_scaler(float value);

  // @@protoc_insertion_point(class_scope:caffe.ExpDecayLossParameter)
 private:
  inline void set_has_scaler();
  inline void clear_has_scaler();
  ...
  void InitAsDefaultInstance();
  static ExpDecayLossParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.ExpDecayLossParameter expdecayloss_param = 150;
inline bool LayerParameter::has_expdecayloss_param() const {
  return (_has_bits_[0] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_expdecayloss_param() {
  _has_bits_[0] |= 0x10000000u;
}
inline void LayerParameter::clear_has_expdecayloss_param() {
  _has_bits_[0] &= ~0x10000000u;
}
inline void LayerParameter::clear_expdecayloss_param() {
  if (expdecayloss_param_ != NULL) expdecayloss_param_->::caffe::ExpDecayLossParameter::Clear();
  clear_has_expdecayloss_param();
}
inline const ::caffe::ExpDecayLossParameter& LayerParameter::expdecayloss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.expdecayloss_param)
  return expdecayloss_param_ != NULL ? *expdecayloss_param_ : *default_instance_->expdecayloss_param_;
}
inline ::caffe::ExpDecayLossParameter* LayerParameter::mutable_expdecayloss_param() {
  set_has_expdecayloss_param();
  if (expdecayloss_param_ == NULL) expdecayloss_param_ = new ::caffe::ExpDecayLossParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.expdecayloss_param)
  return expdecayloss_param_;
}
inline ::caffe::ExpDecayLossParameter* LayerParameter::release_expdecayloss_param() {
  clear_has_expdecayloss_param();
  ::caffe::ExpDecayLossParameter* temp = expdecayloss_param_;
  expdecayloss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_expdecayloss_param(::caffe::ExpDecayLossParameter* expdecayloss_param) {
  delete expdecayloss_param_;
  expdecayloss_param_ = expdecayloss_param;
  if (expdecayloss_param) {
    set_has_expdecayloss_param();
  } else {
    clear_has_expdecayloss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.expdecayloss_param)
}
...
// optional float scaler = 1 [default = 1];
inline bool ExpDecayLossParameter::has_scaler() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ExpDecayLossParameter::set_has_scaler() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ExpDecayLossParameter::clear_has_scaler() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ExpDecayLossParameter::clear_scaler() {
  scaler_ = 1;
  clear_has_scaler();
}
inline float ExpDecayLossParameter::scaler() const {
  // @@protoc_insertion_point(field_get:caffe.ExpDecayLossParameter.scaler)
  return scaler_;
}
inline void ExpDecayLossParameter::set_scaler(float value) {
  set_has_scaler();
  scaler_ = value;
  // @@protoc_insertion_point(field_set:caffe.ExpDecayLossParameter.scaler)
}
